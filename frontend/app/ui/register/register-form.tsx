...
export default function RegisterForm() {
    const initialState = {};
    //checks form status in server action
        ...
        <form className="space-y-3" action={dispatch}>
            <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
                ...
                <div className="flex justify-between">
                    <Link className="text-muted text-gray-500 font-semibold" href="/login">
                        Register
                    </Link>
                    <Link className="text-muted text-gray-400" href="/frontend/public">
                        back
                    </Link>
                </div>
            </div>
